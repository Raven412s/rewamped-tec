    ...
    return (
      <div className="relative shadow-lg  w-full min-h-[400px] bg-neutral-900/10 backdrop-blur-sm border border-neutral-800  p-6 rounded-lg flex flex-col items-center text-center lg:text-left mt-4 lg:flex-row lg:items-stretch lg:justify-between">
        ...
        <div className="absolute top-6 left-6">
          <div className="w-40 h-36  sm:w-56 sm:h-52 lg:w-40 lg:h-32 rounded-ss-lg border-4 absolute -left-4 -top-4 lg:-left-6 lg:-top-6 z-0 border-gold shadow-2xl" />
          <div className="w-40 h-36  sm:w-56 sm:h-52 lg:w-40 lg:h-32  bg-slate-300 shadow-2xl flex items-center justify-center z-20 relative overflow-hidden rounded-ee-lg">
            <Image
              src={`/images/${image1}`}
              alt="Product Image 1"
              width={240}
        ...
        <div className="w-40 h-36  sm:w-56 sm:h-52 lg:w-40 lg:h-32 rounded-ee-lg border-4 absolute -right-4 -bottom-4 lg:-right-6 lg:-bottom-6 z-0 border-gold shadow-2xl" />
          <div className="w-40 h-36  sm:w-56 sm:h-52 lg:w-40 lg:h-32  bg-slate-300 shadow-2xl flex items-center justify-center z-20 relative overflow-hidden rounded-ss-lg">
            <Image
              src={`/images/${image2}`}
              alt="Product Image 2"
              width={240}
